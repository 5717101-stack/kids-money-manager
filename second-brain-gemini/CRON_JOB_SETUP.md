...
**💡 דרך קלה:** אם כבר הוספת את המשתנים ב-Web Service, תוכל להעתיק אותם:

1. לך ל-Web Service שלך → **Environment** tab
2. לחץ על **"..."** (3 נקודות) → **"Copy to another service"**
3. בחר את ה-Cron Job שלך
4. כל המשתנים יועתקו אוטומטית! ✅
